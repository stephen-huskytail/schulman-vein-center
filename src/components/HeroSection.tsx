    ...
    <>
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-[#0B2545]">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, rgba(11,37,69,0.95) 0%, rgba(11,37,69,0.85) 55%, rgba(11,37,69,0.45) 100%)",
          }}
          aria-hidden="true"
        />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-16 lg:py-24 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 max-w-2xl">
              ...
              {/* Google Reviews Inline Trust Badge */}
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                <a
                  href="#testimonials"
                  className="inline-flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-2xl px-5 py-3 border border-white/10 hover:bg-white/15 transition-all cursor-pointer max-w-xs"
                >
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-white/60 text-xs">200+ Google Reviews</span>
                  </div>
                </a>
              </motion.div>
            </div>
            ...
            >
              <LeadForm
                isCompact={true}
                textareaRows={3}
                title="Schedule Your Free Screening"
                className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-6 sm:p-7 border border-white/20 relative"
              />
            </motion.div>
          </div>
        </div>

        {/* Scroll indicator — centered bottom of viewport */}
        <motion.a
          href="#about"
          animate={{ y: [0, 8, 0] }}
          transition={{ repeat: Infinity, duration: 1.8, ease: "easeInOut" }}
          className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 hidden md:flex flex-col items-center gap-1 text-white/40 hover:text-white/70 transition-colors"
