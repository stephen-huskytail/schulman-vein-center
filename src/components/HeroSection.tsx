    ...
    <>
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-[#0B2545]">
        ...
        <motion.a
          ...
          className="absolute bottom-16 right-8 lg:right-14 z-10 hidden md:flex items-center gap-3 bg-white rounded-2xl px-4 py-3 shadow-2xl hover:shadow-3xl transition-shadow cursor-pointer"
        ...
        >
          ...
          <div className="flex flex-col gap-0.5">
            <div className="flex items-center gap-1.5">
              <span className="text-gray-900 font-black text-sm leading-none">5.0</span>
            ...
            <span className="text-gray-500 text-xs leading-none">200+ Google Reviews</span>
          </div>
        </motion.a>
